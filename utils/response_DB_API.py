...
"""
Here, we use a third-party vendor's API to make street-level calls to the LLM.

You can get your own API key from DeepBricks AI. See: https://deepbricks.ai/
"""

def generate_prompt_response_DB_api(prompt, model_name="gpt-4o-mini", max_tokens=400):
    """
    The response is generated using the OpenAI API
    :param prompt:
    :param model_name:
    :param max_tokens:
    :return:
