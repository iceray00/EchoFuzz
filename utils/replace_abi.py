...
def main():
    """
    Using the VFCS_abi generated by LLM, the abi in the json file of the same contract name under fuzzing/contracts is replaced in turn, and then the fuzzing process is carried out
    """

    print("^^^\n Current working directory: \n^^^", os.getcwd())
    parser = argparse.ArgumentParser(description="ABI replaced with VFCS_abi")
    parser.add_argument("-i", "--input", type=str, required=True,
                        help="input the VFCS_abi file you want to replace (relative to /root/EchoFuzz/seed_pool)")
    parser.add_argument("-t", "--target_dir", type=str, default="test_field/contracts",
