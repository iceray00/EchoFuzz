...
from prompts.prompt_English.import_VFCS import introduction_VFCS
from prompts.prompt_pro_NeedEN.prompt_pro_EN import pro_1, pro_2_totalBranchSnippet, pro_3_sequence, pro_4_duration, \
    pro_5_coverage, pro_6_covered, pro_7_target
from prompt_phases import generate_response, prompt_vfcs_abi
from chain_guided import extract_contract_name
...
def promptFuzzerPro(contractName, source_code, duration, model_name):
    print("*******************************************************")
    print("######** Iterative Fuzzing generating next VFCS **######")
    print("*******************************************************")
    ...
    # /* testing */
    # you can see the whole prompt here
    # print(total_prompt)
    return fuzzerPro
