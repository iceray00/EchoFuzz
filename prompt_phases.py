...
from utils.response_ollama import generate_prompt_response
from utils.response_DB_API import generate_prompt_response_DB_api
from utils.static_analysis.call_static import call_slither_static_analysis, call_solc_ar_abi, call_solc_abi
